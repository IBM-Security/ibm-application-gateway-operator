...
#TODO this version will need to be updated to @latest at some point when "they" decide
# that https://github.com/kubernetes-sigs/controller-runtime/issues/2720 actually should be fixed
.PHONY: envtest
...
CSV_FILE = config/manifests/bases/ibm-application-gateway-operator.clusterserviceversion.yaml
...
.PHONY: bundle-all
bundle-all: bundle bundle-build bundle-push
...
certs:
	...
	cp test/certs/* /tmp/k8s-webhook-server/serving-certs/
